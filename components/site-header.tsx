        ...
        <div className="flex h-20 items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            ...
            <div className="flex flex-col items-start">
              <Link href="/">
                <span className="font-semibold text-lg text-[#687FE5]">
                  Healium Sono
                </span>
              </Link>
            </div>
          ...
          <nav className="hidden md:flex items-center gap-8">
            <Link
              href="/"
              className="2xl:text-lg text-[#2D2D2D] font-medium hover:text-[#F4A582] transition-colors"
            >
              Home
            </Link>
            <Link
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <Button
              asChild
              className="bg-[#C8B5E8] text-[#2D2D2D] hover:bg-[#B8A5D8] rounded-full px-6"
            >
              <Link href="#contact">Book a demo</Link>
            </Button>
            <Button
              ...
              >
                ...
                <div className="flex flex-col gap-4 px-4 mt-8">
                  ...
                  <Button
                    ...
                    style={{
                      backgroundImage:
                        "linear-gradient(135deg, #afafe7, #e9c3e2 50%, #ebaa88)",
                    }}
                  >
                    <Link href="#contact">Book a demo</Link>
                  </Button>
